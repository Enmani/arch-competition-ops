...
def upsert_competition(db_path: Path, record: CompetitionRecord) -> str:
    ...
    "competition_types": json.dumps(record.competition_types),
        "project_types": json.dumps(record.project_types),
        "building_categories": json.dumps(record.building_categories),
        "official_sectors": json.dumps(record.official_sectors),
        "built_asset_types": json.dumps(record.built_asset_types),
        "design_scopes": json.dumps(record.design_scopes),
        "project_modes": json.dumps(record.project_modes),
    ...
    with connect(db_path) as connection:
        connection.execute(
            ...
            INSERT INTO competitions (
                ...
                languages, competition_types, project_types, building_categories, official_sectors,
                built_asset_types, design_scopes, project_modes, audience, cpv_codes, implementation_path,
                ...
                :regions, :languages, :competition_types, :project_types, :building_categories, :official_sectors,
                :built_asset_types, :design_scopes, :project_modes, :audience, :cpv_codes,
            ...
            ON CONFLICT(id) DO UPDATE SET
                ...
                building_categories = excluded.building_categories,
                official_sectors = excluded.official_sectors,
                built_asset_types = excluded.built_asset_types,
                design_scopes = excluded.design_scopes,
                project_modes = excluded.project_modes,
